...
pub static ALL_CARDS: &[Card] = &[
    ...
    Card { name: "Rambler",        faction: Faction::Villager, alignment: Alignment::Good, lies: false, disguises: false, cant_lie: false, game_start_ability: false, activated_ability: false, corrupted_note: false },
...
mod tests {
    ...
    fn test_card_count() {
        ...
        assert_eq!(ALL_CARDS.iter().filter(|c| c.faction == Faction::Villager).count(), 25);
