...
MINIONS = [
    ...
    Card("Witch", Role.MINION, Alignment.EVIL,
         "Game Start: You can not Reveal the last card. I Lie and Disguise.",
         lies=True, disguises=True, game_start_ability=True),
    ...
    Card("Twin Minion", Role.MINION, Alignment.EVIL,
         "Game Start: I exchange current role data with one alive neighbor of a random Demon. [I sit next to a Demon]. I Lie and Disguise.",
         lies=True, disguises=True, game_start_ability=True),
