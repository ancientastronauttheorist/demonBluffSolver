...
- Current patch support: Rambler adjacent-truthful shut-up behavior, Alchemist corruption-count clues with immunity, native-verified Baa deck-view reveal on death, ordered Shaman/Twin identity traces, public Dreamer two-target automation, the native-current Poet selector, and exact Gemcrafter, Empress, Bishop, Enlightened, Medium, Knitter, Bounty Hunter, Lover, Scout, Oracle, and Hunter clue contracts
